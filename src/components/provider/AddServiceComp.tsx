  ...
  return (
    <div className="flex flex-col p-4">
      ...
      <div className="flex flex-wrap gap-4 justify-center mt-20">
        <div className="animate-fade-right animate-ease-linear bg-providerBlueSecondary w-full md:w-1/3 p-4 flex flex-col items-center rounded-lg shadow-lg">
        ...
        <div className="animate-fade-left animate-ease-linear bg-providerBlueSecondary w-full md:w-1/3 p-4 flex flex-col items-center rounded-lg shadow-lg">
