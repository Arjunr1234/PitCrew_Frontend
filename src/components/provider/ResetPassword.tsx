...
import { resetPasswordService } from "../../services/provider/providerService";
...
function ResetPassword() {
  ...
  const handleResetPassword = async() => {
    if(validateInputs()){
        try {
            const response = await resetPasswordService(providerInfo?.id as string, currentPassword, newPassword);
            if(response.success){
